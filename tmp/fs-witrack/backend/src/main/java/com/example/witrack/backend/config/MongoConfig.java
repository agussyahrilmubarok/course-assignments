...
import com.example.witrack.backend.util.MongoOffsetDateTimeReader;
import com.example.witrack.backend.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("com.example.witrack.backend")
