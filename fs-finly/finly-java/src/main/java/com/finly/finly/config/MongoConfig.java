package com.finly.finly.config;

import com.finly.finly.util.MongoOffsetDateTimeReader;
import com.finly.finly.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("com.finly.finly.repos")
