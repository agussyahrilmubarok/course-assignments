...
class CouponRedisServiceImplTest {
    ...
    @Test
    void testSetCouponPolicy_whenValidPolicy_shouldCacheIt() throws JsonProcessingException {
    ...
    @Test
    void testSetCouponPolicy_whenJsonProcessingFails_shouldThrowRuntimeException() throws JsonProcessingException {
    ...
    @Test
    void testGetCouponPolicy_whenPolicyExistsInRedis_shouldReturnPolicy() throws JsonProcessingException {
    ...
    @Test
    void testGetCouponPolicy_whenPolicyDoesNotExistInRedis_shouldReturnNull() {
        when(redissonClient.getBucket("coupon:policy:" + TEST_POLICY_ID)).thenReturn(mockObjectBucket);
    ...
    @Test
    void testGetCouponPolicy_whenJsonDeserializationFails_shouldThrowRuntimeException() throws JsonProcessingException {
        String policyJson = "{\"id\":\"COUPON_POLICY_1\",\"name\":\"Test Coupon\"}";
    ...
    @Test
    void testSetCouponPolicyQuantity_whenCalled_shouldSetQuantityInRedis() {
    ...
    @Test
    void testGetCouponPolicyQuantity_whenQuantityExists_shouldReturnQuantity() {
        when(redissonClient.getAtomicLong("coupon:quantity:" + TEST_POLICY_ID)).thenReturn(mockAtomicLong);
    ...
    @Test
    void testGetAllCouponPolicyQuantities_whenQuantitiesExist_shouldReturnAllQuantities() {
    ...
    @Test
    void testSetCouponState_whenValidCoupon_shouldCacheIt() throws JsonProcessingException {
    ...
    @Test
    void testSetCouponState_whenJsonProcessingFails_shouldThrowRuntimeException() throws Exception {
    ...
    @Test
    void testGetCouponState_whenExistsInRedis_shouldReturnCouponResponse() throws JsonProcessingException {
    ...
    @Test
    void testGetCouponState_whenNotExistsInRedis_shouldReturnNull() {
        when(redissonClient.getBucket("coupon:state:" + TEST_COUPON_ID)).thenReturn(mockObjectBucket);
        when(mockObjectBucket.get()).thenReturn(null);
