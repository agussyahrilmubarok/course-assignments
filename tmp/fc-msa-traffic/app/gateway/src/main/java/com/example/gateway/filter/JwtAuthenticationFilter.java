...
//                return validateToken(token)
//                        .flatMap(userId -> proceedWithUserId(userId, exchange, chain))
//                        .switchIfEmpty(Mono.error(new InvalidTokenException("Token validation failed")))
//                        .onErrorResume(InvalidTokenException.class, e -> handleAuthenticationError(exchange, e));
//            }
//
//            return Mono.error(new InvalidTokenException("Missing Authorization header"));
//        };
//    }
