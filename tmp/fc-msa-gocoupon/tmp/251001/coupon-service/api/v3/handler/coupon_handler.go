...
import (
	...
	v3 "example.com/coupon/internal/coupon/feature/v3"
...
type couponHandler struct {
	couponFeature v3.ICouponFeature
	log           zerolog.Logger
	tracer        trace.Tracer
}

func NewCouponHandler(couponFeature v3.ICouponFeature, log zerolog.Logger, tracer trace.Tracer) *couponHandler {
