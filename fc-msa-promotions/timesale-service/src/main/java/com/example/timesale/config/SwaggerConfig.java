...
public class SwaggerConfig {
    ...
    public OpenAPI openApiSpec() {
        return new OpenAPI()
                .info(new Info()
                        .title("Time Sale Service API in Promotions")
                        .version("1.0.0"))
    ...
    public GroupedOpenApi openApiGroupV1Spec() {
        return GroupedOpenApi.builder()
                .group("v1")
                .packagesToScan("com.example.timesale.rest.v1")
                .build();
    }
    ...
    public GroupedOpenApi openApiGroupV2Spec() {
        return GroupedOpenApi.builder()
                .group("v2")
                .packagesToScan("com.example.timesale.rest.v2")
                .build();
    }
    ...
    public GroupedOpenApi openApiGroupV3Spec() {
        return GroupedOpenApi.builder()
                .group("v3")
                .packagesToScan("com.example.timesale.rest.v3")
                .build();
    }
}