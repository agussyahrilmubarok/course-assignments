...
import (
	...
	v2 "example.com/coupon/internal/coupon/feature/v2"
...
type couponHandler struct {
	couponFeature v2.ICouponFeature
	log           zerolog.Logger
	tracer        trace.Tracer
}

func NewCouponHandler(couponFeature v2.ICouponFeature, log zerolog.Logger, tracer trace.Tracer) *couponHandler {
