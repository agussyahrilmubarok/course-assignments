...
import com.example.coupon.service.v3.CouponPolicyService;
...
@RestController("CouponPolicyResourceV3")
@RequestMapping(value = "/api/v3/couponPolicies", produces = MediaType.APPLICATION_JSON_VALUE)
