...
<template>
  <footer class="bg-[#3B41E3] py-20 text-white text-lg">
    <div class="container mx-auto">
      <div class="sm:flex mb-4">
        <div class="sm:w-1/2 sm:mt-0 mt-8 h-auto">
          <img :src="LogoFooter" alt="Logo" class="mb-3" />
          <p class="font-light">
        ...
        <div class="sm:w-1/4 h-auto">
          ...
          <ul class="font-light">
            <li class="mb-3">+021 1234 5678</li>
            <li class="mb-3">JKT, Jakarta</li>
            <li class="mb-3">No.77 (BackerHub)</li>
            <li class="mb-3">support@backerhub.org</li>
          </ul>
        </div>
      </div>
    </div>
