...
public class ReviewResource {
    ...
    public ResponseEntity<EntityModel<ReviewDTO.Response>> createReview(@RequestBody @Valid final ReviewDTO.ReviewRequest payload) {
    ...
    public ResponseEntity<EntityModel<ReviewDTO.Response>> updateReview(@PathVariable(name = "id") final Long id,
                                                                        @RequestBody @Valid final ReviewDTO.ReviewRequest payload) {
