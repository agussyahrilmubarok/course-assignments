...
import (
	...
	v4 "example.com/coupon/internal/coupon/feature/v4"
...
type couponHandler struct {
	couponFeature v4.ICouponFeature
	log           zerolog.Logger
	tracer        trace.Tracer
}

func NewCouponHandler(couponFeature v4.ICouponFeature, log zerolog.Logger, tracer trace.Tracer) *couponHandler {
