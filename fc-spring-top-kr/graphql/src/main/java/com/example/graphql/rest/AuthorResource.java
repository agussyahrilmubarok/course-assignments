...
public class AuthorResource {
    ...
    public ResponseEntity<EntityModel<AuthorDTO.Response>> createAuthor(@RequestBody @Valid final AuthorDTO.AuthorRequest payload) {
    ...
    public ResponseEntity<EntityModel<AuthorDTO.Response>> updateAuthor(@PathVariable(name = "id") final Long id,
                                                                        @RequestBody @Valid final AuthorDTO.AuthorRequest payload) {
