        ...
        "/coupons/cancel": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Cancel coupon payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/coupon.CancelCouponRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/coupons/issue": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Issue coupon payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/coupons/use": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Use coupon payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
...
func init() {
	swag.Register("couponsApiV1", SwaggerInfo)
}
