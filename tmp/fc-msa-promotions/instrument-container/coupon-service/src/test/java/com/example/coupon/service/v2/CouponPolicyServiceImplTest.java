...
class CouponPolicyServiceImplTest {
    ...
    @Test
    void testFindAll_whenPoliciesExist_shouldReturnListOfPolicies() {
    ...
    @Test
    void testFindById_whenIdExists_shouldReturnCouponPolicy() {
    ...
    @Test
    void testFindById_whenIdNotExist_shouldThrowException() {
    ...
    @Test
    void testCreate_whenValidRequest_shouldReturnSavedCouponPolicy() {
