...
import com.example.grpc.client.service.BookService;
...
public class BookResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EntityModel<BookDTO.ResponseDetail>> getBook(@PathVariable(name = "id") final Long id) {
        BookDTO.ResponseDetail bookDTO = bookService.get(id);

        EntityModel<BookDTO.ResponseDetail> entityModel = EntityModel.of(bookDTO,
    ...
    public ResponseEntity<EntityModel<BookDTO.Response>> createBook(@RequestBody @Valid final BookDTO.Request payload) {
    ...
    public ResponseEntity<EntityModel<BookDTO.Response>> updateBook(@PathVariable(name = "id") final Long id,
                                                                    @RequestBody @Valid final BookDTO.Request payload) {
