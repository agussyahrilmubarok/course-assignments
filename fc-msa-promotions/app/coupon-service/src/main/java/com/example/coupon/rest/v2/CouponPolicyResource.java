...
import com.example.coupon.service.v2.CouponPolicyService;
...
@RestController("CouponPolicyResourceV2")
@RequestMapping(value = "/api/v2/couponPolicies", produces = MediaType.APPLICATION_JSON_VALUE)
