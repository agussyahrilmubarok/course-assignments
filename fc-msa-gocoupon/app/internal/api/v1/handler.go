...
func (h *Handler) IssueCoupon(c echo.Context) error {
	ctx, span := instrument.StartSpan(c.Request().Context(), "V1.Handler.IssueCoupon")
	defer span.End()
...
func (h *Handler) CancelCoupon(c echo.Context) error {
	ctx, span := instrument.StartSpan(c.Request().Context(), "V1.Handler.CancelCoupon")
	defer span.End()
...
func (h *Handler) FindCouponByCode(c echo.Context) error {
	ctx, span := instrument.StartSpan(c.Request().Context(), "V1.Handler.FindCouponByCode")
	defer span.End()
