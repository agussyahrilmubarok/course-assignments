package com.example.witrack.backend.controller;
...
import com.example.witrack.backend.exception.ReferencedException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex) {
        ...
        body.put("timestamp", OffsetDateTime.now());
        body.put("status", HttpStatus.BAD_REQUEST.value());
        body.put("message", "Request body is missing or malformed: " + ex.getMostSpecificCause().getMessage());
    ...
    public ResponseEntity<Object> handleDuplicateKey(DuplicateKeyException ex) {
        ...
        body.put("message", "Duplicate key: " + ex.getMostSpecificCause().getMessage());
