package com.example.timesale.rest.v1;
...
@RestController("TimeSaleResourceV1")
@RequestMapping(value = "/api/v1/timeSales", produces = MediaType.APPLICATION_JSON_VALUE)
public class TimeSaleResource {

    private final TimeSaleService timeSaleService;

    public TimeSaleResource(@Qualifier("TimeSaleServiceImplV1") TimeSaleService timeSaleService) {
